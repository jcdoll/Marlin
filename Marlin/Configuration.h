...
#define DELTA_SMOOTH_ROD_OFFSET 213.8 // mm
...
const bool Z_MIN_INVERTING = true;   // set to true for a zprobe endstop that is NC
...
#define Z_MIN_POS 0
#ifdef DELTA
  #define R_MAX 105           // maximum usable radius (mm)
